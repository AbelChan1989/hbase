package com.abel.demo.hbase.test;
...
public class WordStat {
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
        ...
        Scan scan = new Scan();
        //指定要查询的列族
        scan.addColumn(Bytes.toBytes("r"), null);
        //指定Mapper读取的表为word
        TableMapReduceUtil.initTableMapperJob("member2", scan, MyMapper.class, Text.class, IntWritable.class, job);
        //指定Reducer写入的表为stat
